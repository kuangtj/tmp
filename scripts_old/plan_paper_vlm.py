...
AGENTS = {
    "structure_figure": ["ChemEagleStructureAgent", "CompoundStructureAlignAgent"],
    "sar_table": ["ChemEagleStructureAgent", "CompoundStructureAlignAgent"],
    "supplementary_structure_table": ["ChemEagleStructureAgent", "CompoundStructureAlignAgent"],

    "assay_table": ["AssayAgent", "IPMKnowledgeAgent"],
    "supplementary_assay_table": ["AssayAgent", "IPMKnowledgeAgent"],
    "western_blot_figure": ["AssayAgent", "IPMKnowledgeAgent"],
    "dose_response_curve": ["AssayAgent", "IPMKnowledgeAgent"],

    "mechanism_figure": ["IPMKnowledgeAgent"],
    "text_evidence": ["IPMKnowledgeAgent", "AssayAgent"],
...
Definitions:
- structure_figure: chemical structure drawings, molecule panels, compound structures, PROTAC/MG structures, linker/warhead/E3 ligand/scaffold/R-group structures.
...
- supplementary_structure_table: supplementary table with compound structures, SMILES, compound names, R-groups, SAR.
...
Rules:
1. Do not miss structure_figure or assay_table.
...
def main():
    ...
    for a in assets:
        if a["asset_type"] == "supplementary_pdf":
            continue
